...
main() {
  env LC_ALL=C tar tf bin_gpos_osx_release/bin_gpos_osx_release.tar.gz | grep "libgpos.so." | sort -n | head -n 1 | sed 's/\.\/lib\/libgpos\.so\./v/' > gpos_github_release_stage_osx/tag.txt
